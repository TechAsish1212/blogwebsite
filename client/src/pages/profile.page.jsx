...
//                                 <img src={profile_img} className='h-48 w-48 rounded-full bg-grey md:w-32 md:h-32' />
                    ...
                    profile_username.length ?
                        <section className='h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12'>
                            ...
                            <div className='flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-l border-grey md:sticky md:top-[100px] md:py-10'>
                                ...
                                <div className='flex gap-4 mt-2'>
                                    {
                                        profileId === username ? <Link to='/setting/edit-profile' className='btn-light rounded-md'>Edit Profile</Link> : ""
                                    }
                                </div>
                                            ...
                                            blogs === null ? (<Loader />) :
                                                (
                                                    <>
                                                        ...
                                                        {/* ✅ FIXED: LoadMoreDataBtn is now outside blogs.results.length check */}
                                                        <LoadMoreDataBtn state={blogs} fetchDataFun={getBlogs} />
                                                    </>
                                                )
                                        }
